...
function getTexrResult(results){
    return`
...
console.log(getTexrResult(getRateData(10, true, true, true, true)))
console.log(getTexrResult(getRateData(10, false, false, false, false)))
